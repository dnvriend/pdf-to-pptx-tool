...
- **Slash Commands**: Quick CLI invocations (e.g., `/pdf-to-pptx-tool:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-pdf-to-pptx-tool`)
...
**File**: `plugins/pdf-to-pptx-tool/.claude-plugin/plugin.json`
...
**Location**: `plugins/pdf-to-pptx-tool/commands/`
...
**Adding New Commands**:
1. Create `plugins/pdf-to-pptx-tool/commands/<command>.md`
...
/pdf-to-pptx-tool:command "argument"
```

## Skills

**Location**: `plugins/pdf-to-pptx-tool/skills/pdf-to-pptx-tool/SKILL.md`
...
Or:
```
Use the skill-pdf-to-pptx-tool to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/pdf-to-pptx-tool/commands/<command>.md`
...
3. `plugins/pdf-to-pptx-tool/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/pdf-to-pptx-tool/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/pdf-to-pptx-tool/commands/

# Check skill
cat plugins/pdf-to-pptx-tool/skills/pdf-to-pptx-tool/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/pdf-to-pptx-tool:help`
3. Try skill: `/skill-pdf-to-pptx-tool`
